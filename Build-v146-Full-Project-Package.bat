...
title Build Delivery List Scanner v146 Full Project ZIP

echo ============================================================
echo  Build Delivery List Scanner v146 Full Project ZIP
echo ============================================================
echo.
...
%PYTHON_EXE% "%PROJECT_ROOT%\Build-v146-Full-Project-Package.py" --project-root "%PROJECT_ROOT%"
