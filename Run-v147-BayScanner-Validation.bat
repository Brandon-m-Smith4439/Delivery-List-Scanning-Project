...
title Delivery List Scanner v147 Validation

echo ============================================================
echo  Delivery List Scanner v147 Validation
echo ============================================================
echo.
...
%PYTHON_EXE% "%PROJECT_ROOT%\Validate-v147-BayScanner.py" --project-root "%PROJECT_ROOT%"
