...
'   prevents an operator from accidentally scanning against yesterdayÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s or the
'   wrong stageÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s snapshot.
'
' Workflow note:
'   Public entry point: keep this name/signature stable unless every button,
'   form, timer, workbook event, and cross-module call is updated too.
...
'
' Why it exists:
'   Done/Error status is the masterÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s final answer; the intake workbook must
