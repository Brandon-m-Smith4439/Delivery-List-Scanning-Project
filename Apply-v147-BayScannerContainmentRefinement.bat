...
title Delivery List Scanner v147 Bay Scanner Update

echo ============================================================
echo  Delivery List Scanner v147 Bay Scanner Containment Refinement
echo ============================================================
echo.
...
%PYTHON_EXE% "%PROJECT_ROOT%\Apply-v147-BayScannerContainmentRefinement.py" --project-root "%PROJECT_ROOT%"
...
echo v147 was not installed. Read the message above.
goto finish

:success
echo v147 installed successfully.
