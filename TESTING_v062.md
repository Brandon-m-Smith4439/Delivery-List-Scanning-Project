# Delivery List Scanner v062 Testing and Maintenance
...
Do not reuse the older launcher that opens the browser before running Python. Replace both the BAT and PS1 with the v062 copies.
...
- Regenerate `CODE_REFERENCE_v062.md` after structural edits.
