...
title Build Delivery List Scanner v149 Full Project ZIP

echo ============================================================
echo  Build Delivery List Scanner v149 Full Project ZIP
echo ============================================================
echo.
...
%PYTHON_EXE% "%PROJECT_ROOT%\Build-v149-Full-Project-Package.py" --project-root "%PROJECT_ROOT%"
