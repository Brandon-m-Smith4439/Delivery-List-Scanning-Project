...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--initialize-schema", action="store_true", help="Run azure_sql_schema.sql before copying")
...
def initialize_azure_schema(cursor: Any, connection: Any) -> None:
    ...
    script = (ROOT / "azure_sql_schema.sql").read_text(encoding="utf-8")
